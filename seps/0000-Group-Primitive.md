...
NOTE: This proposal focuses on non-hierarchical groupings…i.e. simple collections of TPRs with no group hierarchy or namespaces.  Future enhancements can be introduced for 
