...
- Meeting dates and times published in advance on the [MCP community calendar](https://events.modelcontextprotocol.io/)
...
- Meeting dates and times published in advance on the [MCP community calendar](https://events.modelcontextprotocol.io/) when applicable
